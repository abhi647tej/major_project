...
async def get_user_details(user_id):
    try:
        ...
        phone_number = user.phone if user.phone else 'No phone number'
        print(f"User Details: Name: {user_name}, Phone: {phone_number}, Chat ID: {user_id}")
...
async def handler(event):
    ...
    await get_user_details(event.message.sender_id)
